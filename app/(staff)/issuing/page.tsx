...
const Issuing = () => {
  ...
  const handleNewIssue = (issue?: number) => {
    setOpen(true);
    setMessage(
  ...
  const handleManualIssueChange = (e: SubmitEvent<HTMLFormElement>) => {
    e.preventDefault();
  ...
  return (
    ...
    >
      <h3>This issue is currently {active === true ? status.true : status.false} </h3>

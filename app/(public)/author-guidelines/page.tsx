...
export const metadata: Metadata = {
  title: "Author Guidelines – Delta State Dental And Health Journal",
  description:
    "Detailed submission guidelines for authors submitting manuscripts to the Delta State Dental And Health Journal. Ensure your work meets all required standards.",
};
  ...
  return (
    ...
    >
      ...
      <p>
        ...
        peer-reviewed original research, review articles, short
        communications, and case reports in fields including Dentistry,
        Medicine, Anatomy, Physiology, Nursing, and related health sciences.
      </p>
      ...
      <h3>Title Page</h3>
      <p>
        The title page must include the article title, authors' full names
        with degrees and affiliations (including email), and contact details
      ...
      <h3>Peer Review and Charges</h3>
      <p>
        All manuscripts undergo peer review. A publication fee of N30,000 (or

  ...
  return (
    <>
      <SEO
        ...
        description="Detailed submission guidelines for authors submitting manuscripts to the Delta State Dental And Health Journal. Ensure your work meets all required standards."
      />
      <section
